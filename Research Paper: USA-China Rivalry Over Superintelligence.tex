...
Dans ce document, certaines formulations pourront attribuer à l'intelligence artificielle des actions telles que "comprendre", "décider", "apprendre" ou "répondre". Ces expressions sont employées par convention de langage et ne doivent pas être interprétées comme l'attribution de capacités cognitives, d'intentions ou d'une conscience à ces systèmes pour éviter toute anthropomorphisation de l'intelligence artificielle, qui ne reste rien de plus qu'un ensemble de procédés techniques et algorithmiques. C'est ici le même procédé que pour une entreprise : nous pouvons dire "Apple veut" et "Apple a déclaré", pourtant Apple n'est pas un humain avec des émotions. C'est pareil pour les IA : elles agissent avec un comportement dans un environnement.
...
Il est important de differencier les "IA génératives" du reste des IA car toutes ne sont pas fondamentalement mauvaises.

\section{Introduction}

\section{Qu'est-ce que l'ASI ?}
...
\section{Deux camps avec deux visions opposées.}

\subsection{}

\subsection{}

\section{Quels avenirs possibles ?}
